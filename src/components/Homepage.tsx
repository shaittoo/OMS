    ...
    <div>
      <div className="mx-auto px-6 lg:max-w-7xl lg:px-8">
        <div className="mt-10 grid gap-4 sm:mt-16 lg:h-auto lg:grid-cols-5 lg:grid-rows-4" style={{gridTemplateRows: '40% 10% 10% 40%'}}>
          ...
          <div className="relative lg:col-start-4 lg:row-start-3">
            <Link href="/choose" className="absolute inset-px pt-5 block">
              <span className='py-4 rounded-3xl block' style={{backgroundColor: 'rgba(135,54,234,0.1)'}}>
                <span className='text-center block' style={{fontSize: '32px', fontFamily: 'Arial'}}>
                  Sign up
                </span>
              </span>
            </Link>
          ...
          <div className="relative lg:col-start-5 lg:row-start-3">
            <Link href="/login" className="absolute inset-px pt-5 block">
              <span className='py-4 rounded-3xl block' style={{backgroundColor: 'rgba(135,54,234,0.1)'}}>
                <span className='text-center block' style={{fontSize: '32px', fontFamily: 'Arial'}}>
                  Log in
                </span>
          ...
          <div className="relative lg:col-start-4 lg:row-start-4 lg:col-span-2 pt-8"> {/* card 6 */}
            <Link href="/guestviewevents" className="block">
              <span className="grid lg:grid-cols-2 lg:grid-rows-2 rounded-3xl block" style={{backgroundColor: 'rgba(135,54,234,1)'}}>
                <span className="flex lg:col-start-2 lg:col-span-1 lg:row-span-1 pl-44 pb-10">
